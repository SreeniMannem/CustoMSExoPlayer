...
public final class RtspMediaSource extends BaseMediaSource {
  ...
  private static final String TAG = "RtspMediaSource";
  ...
  public static final class Factory implements MediaSourceFactory {
    ...
    public RtspMediaSource createMediaSource(MediaItem mediaItem) {
      Log.e(TAG, "rtsp createMediaSource mediaItem: "+mediaItem.playbackProperties);
      Log.e(TAG, "rtsp createMediaSource userAgent: "+userAgent);
  ...
  /* package */ RtspMediaSource(
    ...
    Log.e(TAG, "rtsp uri: "+uri+", userAgent: "+userAgent);
  }
