...
public class PlayerActivity extends AppCompatActivity
  ...
  protected boolean initializePlayer() {
    /*if (player == null) {
      ...
      Log.e(TAG, "rtsp initializePlayer preferExtensionDecoders: "+preferExtensionDecoders);
      ...
      *//*mediaSource =
          new RtspMediaSource.Factory()
              .createMediaSource(MediaItem.fromUri("rtsp://192.168.0.13:554/11"));*//*
    ...
    Log.e(TAG, "rtsp player.setMediaItems: has been set: "+mediaItems.size());
    //player.setMediaItem(MediaItem.fromUri("rtsp://192.168.0.13:554/11"));
    player.prepare();
    Log.e(TAG, "rtsp player.prepare(): has been called ");*/
    ...
    Log.e(TAG,"rtsp:mediaSource: "+mediaSource.toString());
    player.setMediaSource(mediaSource);
    player.prepare();
    Log.e(TAG, "rtsp:player.prepare();");
    player.setPlayWhenReady(true);
    Log.e(TAG,"rtsp:player.setPlayWhenReady(true)");
    ...
    player.addListener(new Player.Listener() {
      ...
      public void onPlayerError(@NonNull PlaybackException error) {
        Log.e(TAG, "Unable to preview due to RTSP "+error.getMessage());
        Toast.makeText(PlayerActivity.this, "Unable to preview due to RTSP "+error.getMessage(), Toast.LENGTH_LONG).show();
      }
