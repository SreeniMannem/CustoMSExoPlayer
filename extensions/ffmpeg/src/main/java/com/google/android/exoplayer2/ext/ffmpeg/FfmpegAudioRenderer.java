...
public final class FfmpegAudioRenderer extends DecoderAudioRenderer<FfmpegAudioDecoder> {
  ...
  public FfmpegAudioRenderer(
    ...
    Log.e(TAG, "rtsp FfmpegAudioRenderer: ");
  }
  ...
  protected int supportsFormatInternal(Format format) {
    Log.i(TAG, "rtsp supportsFormatInternal format: "+format);
    String mimeType = Assertions.checkNotNull(format.sampleMimeType);

    if (!FfmpegLibrary.isAvailable() || !MimeTypes.isAudio(mimeType)) {
      Log.i(TAG, "rtsp supportsFormatInternal FORMAT_UNSUPPORTED_TYPE");
      ...
      Log.i(TAG, "rtsp supportsFormatInternal FORMAT_UNSUPPORTED_SUBTYPE");
      return C.FORMAT_UNSUPPORTED_SUBTYPE;
    } else if (format.exoMediaCryptoType != null) {
      Log.i(TAG, "rtsp supportsFormatInternal FORMAT_UNSUPPORTED_DRM");
      return C.FORMAT_UNSUPPORTED_DRM;
    } else {
      Log.i(TAG, "rtsp supportsFormatInternal FORMAT_HANDLED");
  ...
  protected FfmpegAudioDecoder createDecoder(Format format, @Nullable ExoMediaCrypto mediaCrypto)
    ...
    Log.e(TAG, "rstp createDecoder format: "+format);
  ...
  public Format getOutputFormat(FfmpegAudioDecoder decoder) {
    ...
    Log.e(TAG, "rstp getOutputFormat decoder: "+decoder);
